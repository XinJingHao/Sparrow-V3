...
from Sparrow_V3 import Sparrow, str2bool
import argparse
import torch


parser = argparse.ArgumentParser()
'''Hyperparameter Setting for Agent'''
parser.add_argument('--ModelIdex', type=int, default=2799, help='which model(e.g. 2799k.pth) to load')
...
parser.add_argument('--ET', type=str2bool, default=False, help='if True: DT2 Exceed D will be regarded as Termination')
...
parser.add_argument('--RSEO', type=str2bool, default=True, help='Robot Scan Each Other')
...
parser.add_argument('--Obs_V', type=int, default=25, help='maximal obstacle velocity, cm/s')
...
parser.add_argument('--show_ld', type=int, default=False, help='whether to render lidar streams')
